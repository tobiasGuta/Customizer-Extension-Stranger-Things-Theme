...
public class CustomTheme extends IntelliJTheme.ThemeLaf {
    ...
    public UIDefaults getDefaults() {
        UIDefaults defaults;
        LookAndFeel burpBase;
        try {
            if (isDark()) {
                burpBase = (LookAndFeel) burpDark.getConstructor().newInstance();
            }else{
                burpBase = (LookAndFeel) burpLight.getConstructor().newInstance();
            }
...
//        defaults.put("Test", "#00FF00");
        ...
        defaults.put("ColourPalette.mono0", "lazy(Panel.background)");
        ...
        defaults.put("BurpPalette.mono0", "lazy(Panel.background)");
...
//
        defaults.put("DesignSystemPalette.grey0", "lazy(Panel.background)");
        ...
        defaults.put("[dark]Burp.backgrounder", "lighten(Panel.background,2%,lazy)");
        defaults.put("[light]Burp.backgrounder", "darken(Panel.background,2%,lazy)");
